...
//	}
	...
	{
		$query = "select station_id, ref_north_latitude, ref_east_longitude, ref_velocity_north, ref_velocity_east, station_type from cgm_station_velocities -- tablesample system(30) -- where station_id = 'P255'--  -- LIMIT 100";
