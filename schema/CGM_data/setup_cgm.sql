...
UPDATE tmp1 set station_type = 'NA';
...
UPDATE CGM_gnss_station_velocities
   SET station_type = 
      ( select type FROM CGM_gnss_sites
           where CGM_gnss_station_velocities.station_id = CGM_gnss_sites.name);	
